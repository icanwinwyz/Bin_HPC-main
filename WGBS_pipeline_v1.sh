...
display_usage() {
    ...
    echo "   The fourth input is a temporary folder. Without setting an additional temporary folder, the defacult system's TMP directory will be filling up and the program will crash. "
    echo "Output files:"
