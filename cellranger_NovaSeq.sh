...
CELLRANGER="/home/genomics/genomics/apps/cellranger-6.0.0"
...
$CELLRANGER/cellranger mkfastq --run $SEQ_PATH/$2 --samplesheet=$SEQ_PATH/$2/SampleSheet.csv --use-bases-mask Y28,I8n*,n*,Y90 --barcode-mismatches=0 --output-dir=$FOLDER_PATH/$FN &> demultiplex_log.txt
#$CELLRANGER/cellranger mkfastq --run $SEQ_PATH/$2 --samplesheet=$SEQ_PATH/$2/SampleSheet.csv --barcode-mismatches=0 --output-dir=$FOLDER_PATH/$FN &> demultiplex_log.txt
